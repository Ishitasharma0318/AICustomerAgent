...
![API Gateway Lambda authorization workflow](/images/apigateway/latest/developerguide/images/custom-auth-workflow.png)
...
ACCESS_DENIED` or the `401 UNAUTHORIZED` gateway responses. To learn more, see [Gateway responses for REST APIs in API Gateway](./api-gateway-gatewayResponse-definition.html).
